...
public class BinaryTest 
{
    ...
    public void or2() {
        ...
        Binary binary3=Binary.or(binary1,binary2);
        assertEquals("11101", binary3.getValue());
    }
    ...
    public void or3() {
        ...
        Binary binary3=Binary.or(binary1,binary2);
        assertEquals("11111", binary3.getValue());
    }
    ...
    @Test
    public void and3() {
        Binary binary1=new Binary("110100");
        Binary binary2=new Binary("10101");
        Binary binary3=Binary.and(binary1,binary2);
        assertEquals("010100", binary3.getValue());
    }
    ...
    public void multiply2() {
        ...
        Binary binary2=new Binary("1111");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertEquals("100111011", binary3.getValue());
    }
    ...
    public void multiply3() {
        ...
        Binary binary2=new Binary("0");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertEquals("1001100001", binary3.getValue());
    }
}
